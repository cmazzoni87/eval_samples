...
- **Streamlit dashboard**: User-friendly interface for setting up and monitoring evaluations
...
We've added a Streamlit dashboard to make setting up and running evaluations easier. The dashboard provides a user-friendly interface for:

1. Creating evaluations from CSV files
2. Configuring model parameters
3. Selecting judge models
4. Monitoring evaluation progress
5. Viewing and generating reports
...
- Upload CSV files with prompts and golden answers
- Configure task types and descriptions
- Select models to evaluate and adjust token pricing
- Monitor active evaluations with progress bars
- View completed evaluation results
- Generate HTML reports

This provides a more intuitive way to work with the benchmarking framework, especially for users who prefer a visual interface over command-line operations.
...
- `src/streamlit_dashboard.py`: Streamlit dashboard for setting up and monitoring evaluations
